...
You can write tests for the portions of the application related to security.

- [ ] Describe how web servers work.

Web servers receive requests from browsers and send back what they are asked for.
